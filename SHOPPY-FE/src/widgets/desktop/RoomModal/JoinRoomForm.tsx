...
import type { JoinRoomFormData } from '../../../entities/room/types/desktopRoomModal.types';
...
const JoinRoomForm: React.FC<JoinRoomFormProps> = ({ formData, onChange, onSubmit, isLoggedIn }) => {
